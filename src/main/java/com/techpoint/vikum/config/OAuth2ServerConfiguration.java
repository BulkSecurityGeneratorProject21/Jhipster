package com.techpoint.vikum.config;

import com.techpoint.vikum.config.oauth2.MongoDBApprovalStore;
import com.techpoint.vikum.config.oauth2.MongoDBAuthorizationCodeServices;
import com.techpoint.vikum.config.oauth2.MongoDBClientDetailsService;
import com.techpoint.vikum.config.oauth2.MongoDBTokenStore;
import com.techpoint.vikum.repository.*;
...
public class OAuth2ServerConfiguration {
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
            resources.resourceId("res_mark1").tokenStore(tokenStore);
        }
    }
