...
import com.techpoint.vikum.config.oauth2.OAuth2AuthenticationReadConverter;
...
@Configuration
@EnableMongoRepositories("com.techpoint.vikum.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory) throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.techpoint.vikum.config.dbmigrations");
